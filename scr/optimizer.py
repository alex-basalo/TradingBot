...
USE_FRIDAY_EXIT = False  # Schließt alle offenen Trades am Freitag um 21:00 Uhr
...
class ClusterOptimizer:
        ...
        for i in range(1, len(closes)):
            if in_trade:
                ...
                if USE_FRIDAY_EXIT and is_friday_close[i]:
                    ...
                    in_trade = False
                    continue # Überspringe SL/TP für diese Kerze, da geschlossen ist
                ...
                # --- ENTRY LOGIK ---
                # Kein Neueinstieg freitags abends, wenn USE_FRIDAY_EXIT aktiv ist
                if USE_FRIDAY_EXIT and is_friday_close[i]:
                    continue
    ...
    def objective(self, trial: optuna.Trial) -> float:
        ...
        # Prüfen auf statistische Signifikanz für das GESAMTE Cluster
...
if __name__ == "__main__":
    ...
    if os.path.exists(test_file):
        ...
        optimizer.run_optimization(n_trials=50)
