...
class EnsembleEvaluator:
    ...
    def run(self):
        ...
        print(f"\nStarte ENSEMBLE REVERSE-Auswertung (Hybrid-Modell): '{self.experiment_name}'")
        print("=" * 75)
...
if __name__ == "__main__":
    ...
    EXPERIMENT = "Reverse_OOS_Ensemble_Hybrid"
    
    # Trage hier die beiden REVERSE CSV-Dateien ein
    DATEI_MIT_EXIT = "params_WITH_friday_exit_reverse.csv"
    DATEI_OHNE_EXIT = "params_WITHOUT_friday_exit_reverse.csv"
