...
class EnsembleEvaluator:
    ...
    def run(self):
        ...
        print(f"\nStarte ENSEMBLE Auswertung (Hybrid-Modell): '{self.experiment_name}'")
        print("=" * 75)
...
if __name__ == "__main__":
    ...
    EXPERIMENT = "Ensemble_Hybrid_Modell"
    
    # Trage hier die beiden CSV-Dateien ein, die das Skript vergleichen soll
    DATEI_MIT_EXIT = "params_WITH_friday_exit_(500).csv"
    DATEI_OHNE_EXIT = "params_WITHOUT_friday_exit_(500).csv"
