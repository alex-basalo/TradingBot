...
class ExperimentEvaluator:
    ...
    def _extract_trades(self, df: pd.DataFrame, params: dict, use_friday_exit: bool) -> list:
        ...
        """
        # Kategorie A: Zonen-Indikator hinzufügen
        ...
        # Werte als saubere Numpy-Arrays extrahieren
        ...
        # Signale definieren: Regime + Zone + Momentum + Trend (Kategorie C integriert)
    ...
    def run(self):
        ...
        # 2. Portfolio Sortieren & OOS Split identifizieren (70% Train, 30% Test)
...
if __name__ == "__main__":
    ...
    # 1. Gib deinem Experiment einen Namen 
    EXPERIMENT = "Mit_Friday_Exit_Mit_Kategorie_C_500_Trials"
    
    # 2. Welches CSV-Regelwerk soll ausgewertet werden?
    PARAMETER_DATEI = "params_WITH_friday_exit_(500).csv"
